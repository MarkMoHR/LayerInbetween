...
class PyramidalNet(BaseHeatmapModel):
    def __init__(self,
        ...
        self.cardinality = cardinality
        self.width = width 
        self.inputconv = ResNextModule(inp_channels = inp_channels,
    ...
    def forward_with_downscale_outs(self, x):
        ...
        # backbone
        x_ras = self.hourglass.forward_with_downscale_outs(x)
        output = self.classhead(x_ras)
        return output